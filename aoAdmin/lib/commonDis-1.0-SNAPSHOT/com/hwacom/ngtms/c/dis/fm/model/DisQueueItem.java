...
/* 127 */     return ComparisonChain.start().compare(getPriorityType().getPriority(), that.getPriorityType().getPriority()).compare(getRspPriority(), that.getRspPriority(), (Comparator)Ordering.natural().nullsLast()).compare(getSubPriority(), that.getSubPriority(), (Comparator)Ordering.natural().nullsLast()).result();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
