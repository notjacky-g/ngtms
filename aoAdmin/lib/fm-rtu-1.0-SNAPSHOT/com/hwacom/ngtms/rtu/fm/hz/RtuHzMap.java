...
/*    */   
/*    */   RtuHzMap(String description) {
/* 24 */     this.description = description;
/*    */   }
/*    */   
/*    */   RtuHzMap(String description, String mapStoreBeanName) {
/* 28 */     this.description = description;
/* 29 */     this.mapStoreBeanName = mapStoreBeanName;
/*    */   }
/*    */   
/*    */   RtuHzMap(String description, HzMapIndex[] hzMapIndexes) {
/* 33 */     this.description = description;
/* 34 */     this.hzMapIndexes = hzMapIndexes;
/*    */   }
/*    */   
/*    */   RtuHzMap(String description, String mapStoreBeanName, HzMapIndex[] hzMapIndexes) {
