...
/*     */ 
/*     */ @Configuration
/*     */ @EnableJpaRepositories(entityManagerFactoryRef = "drdbEntityManagerFactory", transactionManagerRef = "drdbTransactionManager", basePackages = {"com.hwacom.ngtms.hcce.recovery"}, includeFilters = {@Filter(type = FilterType.ANNOTATION, value = {DrRepository.class})})
...
/*  80 */         .getProperty("drds.connectionTimeout", Long.class, Long.valueOf(10000L))).longValue());
...
/*     */   public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("drdbDataSource") DataSource dataSource) throws ClassNotFoundException {
...
/* 161 */     jpaProterties.put(ConfigProperties.HIBERNATE_NAMING_STRATEGY[0], ConfigProperties.HIBERNATE_NAMING_STRATEGY[1]);
/*     */ 
/*     */     
/* 164 */     jpaProterties.put(ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[0], ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[1]);
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 173 */     if (this.environment.getProperty("ngtms.product.mode") != null && "false"
/* 174 */       .equalsIgnoreCase(this.environment.getProperty("ngtms.product.mode")) && 
