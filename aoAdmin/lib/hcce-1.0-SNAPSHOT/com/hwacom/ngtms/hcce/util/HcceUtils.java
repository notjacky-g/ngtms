...
/*  35 */     Member member = HzUtils.getMembers().iterator().next();
...
/*  49 */     Member coordinator = hzInstance.getCluster().getMembers().iterator().next();
...
/*  71 */     IMap<String, TopologyInfo> topologyInfoMap = HzUtils.getMap((HzDistObjEnum)HzMap.TopologyInfo);
...
/*  74 */       if (Objects.equals(cmIpAddress, topologyNode.getLastRegIpAddress())) {
...
/* 151 */     IMap<String, FmeExeStatus> fmeExeStatusMap = HzUtils.getMap((HzDistObjEnum)HzMap.FmeExeStatus);
