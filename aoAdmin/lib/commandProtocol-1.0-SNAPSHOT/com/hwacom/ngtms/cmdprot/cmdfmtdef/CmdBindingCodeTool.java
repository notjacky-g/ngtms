...
/* 105 */       .append(tab)
/* 106 */       .append('\t')
/* 107 */       .append("byte[] bytes = ")
/* 108 */       .append(name)
/* 109 */       .append(" == null ? new byte[0] : ")
/* 110 */       .append(name)
/* 111 */       .append(".getBytes(java.nio.charset.Charset.forName(\"UTF-8\"));\n");
...
/* 223 */     sb.append(tab)
/* 224 */       .append('\t')
/* 225 */       .append("sb.append(\"")
/* 226 */       .append(name)
/* 227 */       .append(": \").append(com.hwacom.ngtms.cmdprot.cmdfmtdef.BytesUtility.toHexString(")
/* 228 */       .append(name)
/* 229 */       .append(")).append(\", \");\n");
/*     */   }
/*     */   
...
/* 233 */     sb.append(tab)
/* 234 */       .append('\t')
/* 235 */       .append("sb.append(\"")
/* 236 */       .append(name)
/* 237 */       .append(": \").append(" + BytesUtility.class.getName() + ".toHexString(")
/* 238 */       .append(name)
/* 239 */       .append(")).append(\", \");\n");
/*     */   }
/*     */ 
...
/* 313 */     classSb
/* 314 */       .append(tab)
/* 315 */       .append("@CommandParam(name=\"")
/* 316 */       .append(list.getVehicleNoName())
/* 317 */       .append("\")\n");
...
/* 392 */     if (classExtendMap != null) customizeCode = classExtendMap.get(params.getName()); 
...
/* 469 */       customizeCode = classExtendMap.get(command.getName());
/* 470 */       if (customizeCode == null) customizeCode = classExtendMap.get("*"); 
/*     */     } 
...
/* 561 */       ValueElement value; ByteArrayElement byteArray; BitArrayElement bitArray; FixBytesElement fixBytes; ListElement list; StringBuilder listToStringSb; StringBuilder listWriteExternalSb; StringBuilder listReadExternalSb; Ct3VehicleListElement vehicleList; StringBuilder vListToStringSb; StringBuilder vListWriteExternalSb; StringBuilder vListReadExternalSb; List<XmlElement> listParamsList; List<XmlElement> newListParamsList; int i; ParamsRefElement paramsRef; switch (param.elType) {
/*     */         case VALUE:
/* 563 */           value = (ValueElement)param;
...
/*     */         
/*     */         case BYTE_ARRAY:
/* 609 */           byteArray = (ByteArrayElement)param;
...
/*     */         
/*     */         case BIT_ARRAY:
/* 615 */           bitArray = (BitArrayElement)param;
...
/*     */         
/*     */         case FIX_VALUE:
/* 624 */           fixBytes = (FixBytesElement)param;
...
/*     */         
/*     */         case LIST:
/* 634 */           list = (ListElement)param;
/* 635 */           listToStringSb = new StringBuilder();
/* 636 */           listWriteExternalSb = new StringBuilder();
/* 637 */           listReadExternalSb = new StringBuilder();
...
/*     */         
/*     */         case CT3_VEHICLE_LIST:
/* 656 */           vehicleList = (Ct3VehicleListElement)param;
/* 657 */           vListToStringSb = new StringBuilder();
/* 658 */           vListWriteExternalSb = new StringBuilder();
/* 659 */           vListReadExternalSb = new StringBuilder();
/* 660 */           listParamsList = vehicleList.getValueOrByteArrayOrBitArray();
/* 661 */           newListParamsList = new ArrayList<>(listParamsList.size() - 1);
/* 662 */           for (i = 1; i < listParamsList.size(); i++) {
...
/*     */         
/*     */         case PARAMS_REF:
/* 690 */           paramsRef = (ParamsRefElement)param;
...
/*     */ 
/*     */   
/*     */   private void genClassSrc(CmdProtMarshaller cmdProtMarshaller, Map<String, CustomizeCode> classExtendMap, boolean genExtend, boolean cleanPackage) throws IOException {
...
/* 744 */       CmdFmtDefElement cmdFmtDef = cmdFmtDefs.get(index);
/* 745 */       parentImportList.clear();
/* 746 */       for (int i = index; i < cmdFmtDefs.size(); i++) {
/* 747 */         CmdFmtDefElement cmdFmtDef1 = cmdFmtDefs.get(i);
...
/*     */ 
/*     */   
/*     */   public void genBindingSrc(String cmdFmtDefFile, Map<String, CustomizeCode> classExtendMap, boolean cleanPackage) throws IOException {
...
/*     */ 
/*     */   
/*     */   public void genBindingSrc(String cmdFmtDefFile, Map<String, CustomizeCode> classExtendMap, boolean genExtend, boolean cleanPackage) throws IOException {
/*     */     try {
