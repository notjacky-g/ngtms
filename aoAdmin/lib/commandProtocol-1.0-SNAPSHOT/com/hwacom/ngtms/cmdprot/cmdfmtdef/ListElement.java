...
/*     */   extends XmlElement
/*     */ {
/*     */   @XmlElements({@XmlElement(name = "value", type = ValueElement.class), @XmlElement(name = "byteArray", type = ByteArrayElement.class), @XmlElement(name = "bitArray", type = BitArrayElement.class), @XmlElement(name = "paramsRef", type = ParamsRefElement.class), @XmlElement(name = "list", type = ListElement.class)})
