...
/* 31 */       Logger.getLogger(SsoWebServiceService.class.getName())
/* 32 */         .log(Level.INFO, "Can not initialize the default wsdl from {0}", "file:/data/workspace/NGTMS-tc-1.0/fm/commonFm/src/wsdl/SsoWebServiceApiForDataSync.wsdl");
/*    */     } 
/*    */     
...
/* 72 */     return getPort(SsoWebServicePort, SsoWebService.class);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 84 */     return getPort(SsoWebServicePort, SsoWebService.class, features);
/*    */   }
/*    */ }
