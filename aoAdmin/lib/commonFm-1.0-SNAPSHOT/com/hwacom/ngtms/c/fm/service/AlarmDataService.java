...
/*  46 */     IMap<String, AlarmTypeConfig> alarmTypeConfigMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.AlarmTypeConfig);
/*  47 */     alarmTypeConfigMap.put(alarmTypeConfig.getAlarmType(), alarmTypeConfig);
/*     */   } @Autowired
/*     */   private AlarmSubTypeConfigRepository alarmSubTypeConfigRepository; @Autowired
/*     */   private AlarmLogRepository alarmLogRepository;
/*     */   public void updateAlarmTypeConfig(AlarmTypeConfig alarmTypeConfig) {
/*  52 */     IMap<String, AlarmTypeConfig> alarmTypeConfigMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.AlarmTypeConfig);
/*  53 */     alarmTypeConfigMap.put(alarmTypeConfig.getAlarmType(), alarmTypeConfig);
/*     */   }
/*     */ 
/*     */   
/*     */   public void removeAlarmTypeConfig(String alarmType) {
/*  58 */     IMap<String, AlarmTypeConfig> alarmTypeConfigMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.AlarmTypeConfig);
...
/*  67 */     IMap<String, AlarmTypeConfig> typeMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.AlarmTypeConfig);
...
/*     */       
/*  74 */       IMap<Integer, AlarmSubTypeConfig> alarmSubTypeConfigMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.AlarmSubTypeConfig);
...
/*     */     } 
/*  79 */     throw new EntityNotFoundException("The alarmTypeConfig with key " + alarmSubTypeConfig
/*  80 */         .getAlarmType() + " was not found");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*  90 */     IMap<Integer, AlarmSubTypeConfig> alarmSubTypeConfigMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.AlarmSubTypeConfig);
...
/*     */     } 
/*  95 */     throw new EntityNotFoundException("The alarmSubTypeConfig with key " + alarmSubTypeConfig
/*     */         
/*  97 */         .getAlarmType() + " was not found");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 104 */     IMap<Integer, AlarmSubTypeConfig> alarmSubTypeConfigMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.AlarmSubTypeConfig);
