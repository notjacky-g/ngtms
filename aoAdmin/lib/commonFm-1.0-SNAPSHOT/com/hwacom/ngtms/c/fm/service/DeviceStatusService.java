...
/*     */ import com.hwacom.ngtms.ncc.tc.ct3.cmdparam.csls.HwStatusPm;
/*     */ import com.hwacom.ngtms.ncc.tc.ct3.cmdparam.lcs.HwStatusPm;
...
/*  39 */       return null;
/*     */     } 
/*  41 */     IMap<String, DeviceTcHardwareStatus> map = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.DeviceTcHardwareStatus);
/*     */     
...
/*     */ 
/*     */     
/*  48 */     PredicateBuilder pb = eo.get("bitNo").equal(Integer.valueOf(bitNo)).and((Predicate)eo.get("deviceType").equal(deviceType).or((Predicate)eo.get("common").equal(Boolean.valueOf(true)))).and((Predicate)eo.get("protocolType").equal((Comparable)protocolType));
/*  49 */     DeviceTcHardwareStatus result = null;
/*  50 */     Iterator<DeviceTcHardwareStatus> iterator = map.values((Predicate)pb).iterator(); if (iterator.hasNext()) { DeviceTcHardwareStatus config = iterator.next();
/*  51 */       result = config; }
/*     */ 
/*     */ 
/*     */     
...
/*  72 */       IMap<String, DeviceTcConfig> tcConfigMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.DeviceTcConfig);
/*     */       
/*  74 */       PredicateBuilder predicateBuilder = (new PredicateBuilder()).getEntryObject().get("deviceType").equal(deviceType);
/*  75 */       for (DeviceTcConfig config : tcConfigMap.values((Predicate)predicateBuilder)) {
...
/*     */     } 
/*  86 */     IMap<String, DeviceTcHardwareStatus> map = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.DeviceTcHardwareStatus);
/*     */     
...
/*     */ 
/*     */     
/*  93 */     PredicateBuilder pb = eo.get("deviceType").equal(deviceType).or((Predicate)eo.get("common").equal(Boolean.valueOf(true))).and((Predicate)eo.get("protocolType").equal((Comparable)protocolType));
/*     */     
/*  95 */     return Lists.newArrayList(map.values((Predicate)pb));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/*     */     
/* 135 */     IMap<String, DeviceTcStatus> deviceStatusMap = HzUtils.getMap((HzDistObjEnum)CommonFmHzMap.DeviceTcStatus);
/* 136 */     EntryObject e = (new PredicateBuilder()).getEntryObject();
/*     */ 
/*     */ 
/*     */     
/* 140 */     PredicateBuilder pb = e.get("deviceType").equal(deviceType.getId()).and((Predicate)e.get("bit" + hardwareStatus.getBitNo()).equal(Boolean.TRUE));
/*     */     
/* 142 */     return Lists.newArrayList(deviceStatusMap.values((Predicate)pb));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   public List<DeviceTcHardwareStatus> getAbnormalHwByLcsHwStatusPm(HwStatusPm hwStatusPm, String deviceType) {
...
/*     */ 
/*     */   
/*     */   public List<DeviceTcHardwareStatus> getAbnormalHwByCslsHwStatusPm(HwStatusPm hwStatusPm, String deviceType) {
...
/*     */   }
/*     */   
/*     */   public DeviceTcStatus fromHwStatusPm(HwStatusPm hwStatusPm, String deviceType) {
...
/*     */ 
/*     */   
/*     */   public DeviceTcStatus fromCt3LcsHwStatusPm(HwStatusPm hwStatusPm, String deviceType) {
...
/*     */ 
/*     */   
/*     */   public DeviceTcStatus fromCt3CslsHwStatusPm(HwStatusPm hwStatusPm, String deviceType) {
...
/*     */   }
/*     */   
/*     */   public static void setByHwStatusPm(HwStatusPm hwStatusPm, DeviceTcStatus deviceStatus) {
...
/*     */ 
/*     */   
/*     */   public static void setByLcsHwStatusPm(HwStatusPm hwStatusPm, DeviceTcStatus deviceStatus) {
...
/*     */ 
/*     */   
/*     */   public static void setByCslsHwStatusPm(HwStatusPm hwStatusPm, DeviceTcStatus deviceStatus) {
