...
public interface DeviceTcStatusRepository extends JpaRepository<DeviceTcStatus, String> {
  @Query("from DeviceTcStatus d where d.id in :deviceNames")
  List<DeviceTcStatus> findByIds(@Param("deviceNames") List<String> paramList);
  
  @Query("select id from DeviceTcStatus")
  Set<String> findAllKeys();
  
  DeviceTcStatus findTopByIdOrderByDataTimeDesc(String paramString);
}
