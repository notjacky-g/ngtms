...
/* 113 */     for (int i = 0, bytesNo = 0; i < arrayNo; i++) {
...
/* 180 */     int x = 0;
/* 181 */     int y = 0;
/* 182 */     for (int i = 0, c = 0; i < byteArrays.length; i++) {
...
/* 247 */     for (int i = 0, bytesNo = 0; i < arrayNo; i++) {
...
/* 300 */     int x = 0;
/* 301 */     int y = 0;
/* 302 */     for (int i = 0, c = 0; i < byteArrays.length; i++) {
