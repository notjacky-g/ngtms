...
/* 158 */     return Optional.<Boolean>ofNullable(this.pwdChanged).orElse(Boolean.valueOf(false));
/*     */   }
/*     */   
...
/* 314 */     return Optional.<Boolean>ofNullable(this.localAccount).orElse(Boolean.valueOf(true));
/*     */   }
/*     */   
