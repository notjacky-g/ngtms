...
/*    */       try {
/* 42 */         cfg.setDirectoryForTemplateLoading(new File(optTemplateDirectory.get()));
...
/*    */ 
/*    */   
/*    */   public void sendMail(User user, String subject, String mailContent, boolean inlineImage, MailAttachment... attachments) throws MessagingException {
...
/* 80 */               .getAttachmentFilename(), (InputStreamSource)new ByteArrayResource(attachment
/* 81 */                 .getBytes()), attachment
/* 82 */               .getContentType());
/*    */         } else {
/* 84 */           helper.addAttachment(attachment
/* 85 */               .getAttachmentFilename(), (InputStreamSource)new ByteArrayResource(attachment
