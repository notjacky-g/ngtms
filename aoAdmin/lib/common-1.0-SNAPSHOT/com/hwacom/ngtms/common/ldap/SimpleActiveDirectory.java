...
/* 169 */     LdapQueryBuilder ldapQueryBuilder = LdapQueryBuilder.query().base(this.searchBase);
/* 170 */     List<String> list = this.ldapTemplate.list(ldapQueryBuilder.base());
...
/* 186 */         (LdapQuery)LdapQueryBuilder.query().base(this.searchBase).where("objectClass").is("person"), new UserAttributesMapper());
...
/* 203 */         (LdapQuery)LdapQueryBuilder.query().base(this.searchBase).where("cn").is(userName), new UserAttributesMapper());
/* 204 */     if (list != null && !list.isEmpty()) {
/* 205 */       return list.get(0);
/*     */     }
/* 207 */     return null;
/*     */   }
/*     */ 
...
/* 213 */         (LdapQuery)LdapQueryBuilder.query().base(this.searchBase).where("sAMAccountName").is(login), new UserAttributesMapper());
...
/* 223 */         (LdapQuery)LdapQueryBuilder.query().base(this.searchBase).where("cn").is(userName), new MultipleAttributesMapper());
...
/* 233 */         (LdapQuery)LdapQueryBuilder.query().base(this.searchBase).where("sAMAccountName").is(login), new MultipleAttributesMapper());
/*     */     
...
/*     */       } 
/* 321 */       mods[3] = new ModificationItem(2, new BasicAttribute("userAccountControl", 
/*     */ 
/*     */             
/* 324 */             Integer.toString(userAccountControl)));
/*     */       
...
/* 403 */       ctx.setAttributeValues("objectclass", (Object[])new String[] { "top", "group" });
/*     */       
/* 405 */       ctx.setAttributeValue("sAMAccountName", role.getName());
/* 406 */       ctx.setAttributeValue("description", role.getDescription());
/* 407 */       this.ldapTemplate.bind((DirContextOperations)ctx);
...
/* 442 */     return new AttributesMapper<String>()
/*     */       {
...
/* 465 */     ContainerCriteria containerCriteria = LdapQueryBuilder.query().base(this.searchBase).where("objectclass").is("group").and("cn").like(roleName + "*");
/* 466 */     return this.ldapTemplate.search((LdapQuery)containerCriteria, mapper);
/*     */   }
/*     */   
/*     */   public List<Role> getAllGroups() {
/* 470 */     return getAllGroups(new RoleAttributesMapper());
/*     */   }
/*     */   
/*     */   public List<Role> getGroupLike(String name) {
/* 474 */     return getGroupLike(name, new RoleAttributesMapper());
/*     */   }
/*     */ 
/*     */   
/*     */   public List<String> getMembersByGroupName(String roleName) {
/* 479 */     AndFilter andFilter = new AndFilter();
/* 480 */     andFilter.and((Filter)new EqualsFilter("objectclass", "person"));
/* 481 */     andFilter.and((Filter)new EqualsFilter("memberOf", toFullDistinguishedName(roleName).toString()));
...
/* 535 */       pwdArray[i * 2 + 1] = (byte)(unicodePwd[i] >>> 8);
...
/*     */   }
/*     */   
/*     */   private class SingleNameAttributesMapper
/*     */     implements AttributesMapper<String>
/*     */   {
