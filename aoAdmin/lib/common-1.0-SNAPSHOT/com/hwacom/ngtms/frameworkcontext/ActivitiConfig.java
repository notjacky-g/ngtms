...
/* 50 */     conf.setMaximumPoolSize(((Integer)this.environment
/* 51 */         .getRequiredProperty("activiti.db.maximumPoolSize", Integer.class)).intValue());
...
/* 53 */     conf.setConnectionTimeout(((Long)this.environment
/* 54 */         .getProperty("activiti.db.connectionTimeout", Long.class, Long.valueOf(10000L))).longValue());
...
/* 74 */     return (PlatformTransactionManager)new DataSourceTransactionManager(dataSource);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/*    */   
/*    */   @Bean
/*    */   public SpringProcessEngineConfiguration springProcessEngineConfiguration(@Qualifier("activitiDataSource") DataSource dataSource, @Qualifier("activitiTransactionManager") PlatformTransactionManager transactionManager, SpringAsyncExecutor springAsyncExecutor) throws IOException {
