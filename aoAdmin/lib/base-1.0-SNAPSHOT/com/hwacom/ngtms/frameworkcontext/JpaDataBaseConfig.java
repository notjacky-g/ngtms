...
/*  69 */     conf.setConnectionTimeout(((Long)this.environment
/*  70 */         .getProperty("olds.connectionTimeout", Long.class, Long.valueOf(10000L))).longValue());
...
/* 120 */     jpaProterties.put(ConfigProperties.HIBERNATE_NAMING_STRATEGY[0], ConfigProperties.HIBERNATE_NAMING_STRATEGY[1]);
/*     */ 
/*     */     
/* 123 */     jpaProterties.put(ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[0], ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[1]);
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 132 */     if (this.environment.getProperty("ngtms.product.mode") != null && "false"
/* 133 */       .equalsIgnoreCase(this.environment.getProperty("ngtms.product.mode")) && 
