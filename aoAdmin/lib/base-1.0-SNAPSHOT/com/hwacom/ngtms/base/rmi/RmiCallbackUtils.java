...
/*  58 */     ProxyFactory pf = new ProxyFactory(clazz, (Interceptor)mi);
/*  59 */     pf.addInterface(Serializable.class);
/*  60 */     return (E)pf.getProxy();
/*     */   }
/*     */   
/*     */   public static void unexport(Object target) {
/*  64 */     Remote remoteProxy = staticRefMap.remove(target);
/*     */     try {
/*  66 */       UnicastRemoteObject.unexportObject(remoteProxy, true);
/*  67 */     } catch (NoSuchObjectException noSuchObjectException) {}
/*     */   }
/*     */   
/*     */   public static class AnonymousRmiServiceExporter
...
/*  82 */     private static RemoteInvocationFactory remoteInvocationFactory = (RemoteInvocationFactory)new DefaultRemoteInvocationFactory();
/*     */ 
/*     */     
