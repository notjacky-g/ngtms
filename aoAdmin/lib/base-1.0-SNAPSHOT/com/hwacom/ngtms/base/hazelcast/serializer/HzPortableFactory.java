...
/* 25 */     Class<? extends Portable> clazz = classMap.get(Integer.valueOf(classId));
/* 26 */     if (clazz == null) {
/* 27 */       return null;
/*    */     }
/*    */     try {
/* 30 */       return clazz.newInstance();
...
/*    */     } else {
/* 42 */       throw new IllegalIcuArgumentException("Duplicated classId, id:" + classId + ", " + clazz
/*    */ 
/*    */ 
/*    */           
/* 46 */           .getName() + ", " + ((Class)classMap
/*    */           
/* 48 */           .get(Integer.valueOf(classId))).getName());
/*    */     } 
/*    */   }
/*    */ }
