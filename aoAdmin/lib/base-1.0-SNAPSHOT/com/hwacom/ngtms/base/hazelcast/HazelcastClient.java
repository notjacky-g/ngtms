...
/*  44 */                   HzClientUtils.create(HazelcastClient.this
/*  45 */                     .environment.getProperty("hz.group.name"), HazelcastClient.this
/*  46 */                     .environment.getProperty("hz.group.password"), (
...
/*  51 */                 HazelcastClient.logger.info("Connect to HzGroup: " + HazelcastClient.this
/*     */                     
/*  53 */                     .environment.getProperty("hz.group.name") + " successfully");
/*     */                 
/*     */                 break;
/*  56 */               } catch (Exception ex) {
/*  57 */                 HazelcastClient.logger.warn("Failed to connect HzGroup: " + HazelcastClient.this
/*     */                     
/*  59 */                     .environment.getProperty("hz.group.name") + ", reconnect after " + reCreatePeriod + " ms.", ex);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  88 */                     HzClientUtils.create(HazelcastClient.this
/*  89 */                       .environment.getProperty("dr.hz.group.name"), HazelcastClient.this
/*  90 */                       .environment.getProperty("dr.hz.group.password"), (
...
/*  96 */                   HazelcastClient.logger.info("Connect to dr HzGroup: " + HazelcastClient.this
/*     */                       
/*  98 */                       .environment.getProperty("dr.hz.group.name") + " successfully");
/*     */                   
/*     */                   break;
/* 101 */                 } catch (Exception ex) {
/* 102 */                   HazelcastClient.logger.warn("Failed to connect dr HzGroup: " + HazelcastClient.this
/*     */                       
/* 104 */                       .environment.getProperty("dr.hz.group.name") + ", reconnect after " + reCreatePeriod + " ms.", ex);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
