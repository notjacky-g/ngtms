...
/*     */           } 
/*  92 */           if (type.equals(boolean.class) || type.equals(Boolean.class))
/*  93 */           { if (obj != null) { writer.writeBoolean(fieldName, ((Boolean)obj).booleanValue()); }
/*  94 */             else { writer.writeBoolean(fieldName, false); }  }
/*  95 */           else if (type.equals(byte.class) || type.equals(Byte.class))
/*  96 */           { if (obj != null) { writer.writeByte(fieldName, ((Byte)obj).byteValue()); }
/*  97 */             else { writer.writeByte(fieldName, (byte)0); }  }
/*  98 */           else if (type.equals(char.class) || type.equals(Character.class))
/*  99 */           { if (obj != null) { writer.writeChar(fieldName, ((Character)obj).charValue()); }
/* 100 */             else { writer.writeChar(fieldName, 32); }  }
/* 101 */           else if (type.equals(int.class) || type.equals(Integer.class))
/* 102 */           { if (obj != null) { writer.writeInt(fieldName, ((Integer)obj).intValue()); }
/* 103 */             else { writer.writeInt(fieldName, 0); }  }
/* 104 */           else if (type.equals(short.class) || type.equals(Short.class))
/* 105 */           { if (obj != null) { writer.writeShort(fieldName, ((Short)obj).shortValue()); }
/* 106 */             else { writer.writeShort(fieldName, (short)0); }  }
/* 107 */           else if (type.equals(long.class) || type.equals(Long.class))
/* 108 */           { if (obj != null) { writer.writeLong(fieldName, ((Long)obj).longValue()); }
/* 109 */             else { writer.writeLong(fieldName, 0L); }  }
/* 110 */           else if (type.equals(float.class) || type.equals(Float.class))
/* 111 */           { if (obj != null) { writer.writeFloat(fieldName, ((Float)obj).floatValue()); }
/* 112 */             else { writer.writeFloat(fieldName, 0.0F); }  }
/* 113 */           else if (type.equals(double.class) || type.equals(Double.class))
/* 114 */           { if (obj != null) { writer.writeDouble(fieldName, ((Double)obj).doubleValue()); }
/* 115 */             else { writer.writeDouble(fieldName, 0.0D); }  }
/* 116 */           else if (Portable.class.isAssignableFrom(type))
/* 117 */           { if (obj != null) { writer.writePortable(fieldName, (Portable)obj); }
/*     */             else
/*     */             { 
/* 120 */               try { writer.writePortable(fieldName, (Portable)type.newInstance()); }
/* 121 */               catch (Exception e)
/* 122 */               { logger.warn("write protable field '{}' have exception!", fieldName, e); }  }
/*     */              }
/* 124 */           else if (type.equals(Date.class))
/* 125 */           { if (obj != null) { writer.writeUTF(fieldName, dateFormat.format((Date)obj)); }
/* 126 */             else { writer.writeUTF(fieldName, ""); }  }
/* 127 */           else if (type.equals(Calendar.class))
/* 128 */           { if (obj != null) { writer.writeUTF(fieldName, dateFormat.format(((Calendar)obj).getTime())); }
/* 129 */             else { writer.writeUTF(fieldName, ""); }  }
...
/* 133 */             if (obj != null)
/* 134 */             { List<Object> list = (List<Object>)obj;
...
/* 140 */             if (obj != null)
/* 141 */             { Set<Object> set = (Set<Object>)obj;
...
/* 148 */             if (obj != null) {
/* 149 */               Map<Object, Object> map = (Map<Object, Object>)obj;
...
/* 167 */       Portable[] protableArray = Arrays.<Portable, Object>copyOf(array, array.length, Portable[].class);
/* 168 */       writer.writePortableArray(fieldName, protableArray);
/* 169 */     } else if (clazz.equals(Integer.class) || clazz.equals(int.class)) {
...
/* 179 */     } else if (clazz.equals(Long.class) || clazz.equals(long.class)) {
...
/*     */             try {
/* 218 */               field.set(this, (Object)null);
/* 219 */             } catch (IllegalArgumentException|IllegalAccessException e) {
...
/* 232 */               valueObj = reader.readPortable(fieldName);
/* 233 */             } else if (type instanceof Class && type.isEnum()) {
/* 234 */               String valueStr = reader.readUTF(fieldName);
/* 235 */               valueObj = Enum.valueOf(type, valueStr);
/* 236 */             } else if (type.equals(Date.class) || type.equals(Calendar.class)) {
/*     */               Date date;
...
/*     */               } 
/* 249 */               if (type.equals(Calendar.class)) {
...
/* 254 */                 valueObj = date;
/*     */               } 
/* 256 */             } else if (type.equals(Boolean.class) || type.equals(boolean.class)) {
/* 257 */               valueObj = Boolean.valueOf(reader.readBoolean(fieldName));
/* 258 */             } else if (type.equals(Character.class) || type.equals(char.class)) {
/* 259 */               valueObj = Character.valueOf(reader.readChar(fieldName));
/* 260 */             } else if (type.equals(Integer.class) || type.equals(int.class)) {
/* 261 */               valueObj = Integer.valueOf(reader.readInt(fieldName));
/* 262 */             } else if (type.equals(Long.class) || type.equals(long.class)) {
/* 263 */               valueObj = Long.valueOf(reader.readLong(fieldName));
/* 264 */             } else if (type.equals(Double.class) || type.equals(double.class)) {
/* 265 */               valueObj = Double.valueOf(reader.readDouble(fieldName));
/* 266 */             } else if (type.equals(Short.class) || type.equals(short.class)) {
/* 267 */               valueObj = Short.valueOf(reader.readShort(fieldName));
/* 268 */             } else if (type.equals(Float.class) || type.equals(float.class)) {
/* 269 */               valueObj = Float.valueOf(reader.readFloat(fieldName));
/* 270 */             } else if (type.equals(Byte.class) || type.equals(byte.class)) {
...
/* 275 */               } catch (InstantiationException|IllegalAccessException e) {
/* 276 */                 Date date; logger.warn("Portable deserializer failed! class:'{}', field:'{}'", new Object[] {
/*     */                       
/* 278 */                       getClass(), field
/* 279 */                       .getName(), date
/*     */                     });
/* 281 */                 throw new IOException(date);
/*     */               } 
/* 283 */             } else if (Map.class.isAssignableFrom(type)) {
/*     */               try {
/* 285 */                 valueObj = readMap(reader, field);
/* 286 */               } catch (InstantiationException|IllegalAccessException e) {
...
/*     */ 
/*     */   
/*     */   private Map<Object, Object> readMap(PortableReader reader, Field field) throws IOException, InstantiationException, IllegalAccessException {
...
/* 351 */       throw new IOException("deseriailiz class:" + field
/*     */           
/* 353 */           .getClass() + " field:" + field
/*     */           
/* 355 */           .getName() + " , amount of key and value is different in map!");
/*     */     }
/*     */ 
/*     */     
...
/*     */     } else {
/* 362 */       map = (Map<Object, Object>)field.getType().newInstance();
/*     */     } 
...
/* 374 */       return (Object[])portableArray;
...
/*     */       }
/* 381 */       return (Object[])arrayLong;
/*     */     } 
/*     */     
/* 384 */     return (Object[])reader.readUTFArray(fieldName);
/*     */   }
/*     */ }
