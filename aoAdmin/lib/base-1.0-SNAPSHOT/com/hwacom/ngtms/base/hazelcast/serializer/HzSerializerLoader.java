...
/*     */       
/*  54 */       NodeList nodeList = doc.getElementsByTagName("HzSerializer"); int i;
/*  55 */       for (i = 0; i < nodeList.getLength(); i++) {
/*  56 */         Node node = nodeList.item(i);
...
/*     */           try {
/*  63 */             typeClass = (Class)Class.forName(typeClassName);
...
/*  84 */       logger.error("Failed to load Hz Serializer declaration: HzPortableSerializer.xml", ex
/*  85 */           .getMessage());
/*     */     } finally {
/*     */       try {
...
/*     */       
/* 109 */       NodeList nodeList = doc.getElementsByTagName("HzSerializer"); int i;
/* 110 */       for (i = 0; i < nodeList.getLength(); i++) {
/* 111 */         Node node = nodeList.item(i);
...
/*     */             
/* 123 */             hzSerializerClass = (Class)Class.forName(hzSerializerClassName);
...
/* 148 */       logger.error("Failed to load Hz Serializer declaration: HzSerializer.xml", ex.getMessage());
/*     */     } finally {
/*     */       try {
