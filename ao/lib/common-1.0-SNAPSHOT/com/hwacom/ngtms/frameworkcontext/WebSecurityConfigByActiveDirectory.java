...
/*     */   {
/*  72 */     LdapTemplate ldapTemplate = new LdapTemplate(ldapContextSource());
...
/*     */     throws Exception
/*     */   {
/* 122 */     auth.authenticationProvider(activeDirectoryLdapAuthenticationProvider()).userDetailsService(userDetailsService());
/*     */   }
/*     */   
/*     */   @Bean
/*     */   public AuthenticationManager authenticationManager() {
/* 127 */     return new ProviderManager(Arrays.asList(new AuthenticationProvider[] { activeDirectoryLdapAuthenticationProvider() }));
/*     */   }
/*     */   
/*     */   @Bean
