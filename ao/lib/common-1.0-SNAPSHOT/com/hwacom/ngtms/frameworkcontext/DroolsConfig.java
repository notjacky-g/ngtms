...
/*  97 */     Scanner scanner = new Scanner(is, "UTF-8");Throwable localThrowable3 = null;
/*  98 */     try { scanner.useDelimiter("\\A");
/*  99 */       return scanner.hasNext() ? scanner.next() : "";
/*     */     }
/*     */     catch (Throwable localThrowable4)
/*     */     {
/*  97 */       localThrowable3 = localThrowable4;throw localThrowable4;
/*     */     }
/*     */     finally {
/* 100 */       if (scanner != null) if (localThrowable3 != null) try { scanner.close(); } catch (Throwable localThrowable2) { localThrowable3.addSuppressed(localThrowable2); } else scanner.close();
/*     */     }
/*     */   }
/*     */ }
