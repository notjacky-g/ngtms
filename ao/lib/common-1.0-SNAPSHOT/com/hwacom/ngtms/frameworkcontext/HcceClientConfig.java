...
/*    */ @EnableScheduling
/*    */ @ComponentScan(basePackages={"com.hwacom.ngtms.base.web", "com.hwacom.ngtms.hcce.am", "com.hwacom.ngtms.common.am", "com.hwacom.ngtms.node.performance.common"}, basePackageClasses={}, excludeFilters={@org.springframework.context.annotation.ComponentScan.Filter(type=org.springframework.context.annotation.FilterType.REGEX, pattern={"com.hwacom.ngtms..*.test.*"})})
/*    */ @ServletComponentScan(basePackages={"com.hwacom.ngtms.base.web", "com.hwacom.ngtms.hcce.am", "com.hwacom.ngtms.common.am"})
/*    */ @PropertySources({@org.springframework.context.annotation.PropertySource({"applicationContext.properties"}), @org.springframework.context.annotation.PropertySource(value={"file:${am.override.config.file}"}, ignoreResourceNotFound=true)})
/*    */ @EnableWebSocket
