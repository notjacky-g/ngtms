...
/*  60 */       T endpoint = wac.getBean(beanName, endpointClass);
...
/*  69 */       T endpoint = wac.getBean(annot.value(), endpointClass);
...
/*     */     
/*  91 */     Map<Class<?>, String> beanNamesByType = (Map)cache.get(wacId);
...
/*     */ 
/*     */ 
/* 108 */           String message = "Found multiple @ServerEndpoint's of type " + endpointClass + ", names=" + Arrays.toString(names);
...
/*     */     }
/*     */     
/* 115 */     String beanName = (String)beanNamesByType.get(endpointClass);
