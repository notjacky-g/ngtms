...
/*     */ 
/*     */ @Entity
/*     */ @NamedQueries({@javax.persistence.NamedQuery(name="ReportExportFile.findAllCategory", query="select distinct f.category from ReportExportFile f"), @javax.persistence.NamedQuery(name="ReportExportFile.findWithCategory", query="select f from ReportExportFile f where f.category = :category"), @javax.persistence.NamedQuery(name="ReportExportFile.findRemoveCandidate", query="select f from ReportExportFile f where f.end < :end")})
/*     */ @Table(indexes={@javax.persistence.Index(columnList="category"), @javax.persistence.Index(columnList="end")})
