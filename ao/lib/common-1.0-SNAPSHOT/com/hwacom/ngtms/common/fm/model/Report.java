...
/*     */ 
/*     */ @Entity
/*     */ @Table(uniqueConstraints={@javax.persistence.UniqueConstraint(columnNames={"category", "sub_category", "name"})}, indexes={@javax.persistence.Index(columnList="name"), @javax.persistence.Index(columnList="module"), @javax.persistence.Index(columnList="module,category"), @javax.persistence.Index(columnList="module,category,sub_category")})
/*     */ @NamedQueries({@javax.persistence.NamedQuery(name="Report.findAllCategory", query="select distinct r.category from Report r"), @javax.persistence.NamedQuery(name="Report.findWithCategory", query="select r from Report r where r.category = :category")})
/*     */ public class Report
