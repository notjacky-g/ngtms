...
/*    */ 
/*    */ 
/* 43 */     this.data = new QrData.Builder().label(label != null ? label : user.getLogin()).secret(user.getMfaSecret()).issuer(issuer).algorithm(HashingAlgorithm.SHA1).digits(6).period(30).build();
/* 44 */     this.generator = new ZxingPngQrGenerator();
/*    */   }
/*    */   
