...
/*  51 */   private SecretGenerator secretGenerator = new DefaultSecretGenerator();
/*     */   
/*     */   @PostConstruct
/*     */   public void init() {
...
/*  59 */     IMap<String, User> userMap = HzUtils.getMap(CommonHzMap.AccountUser);
...
/*     */     try {
/*  73 */       IMap<String, User> userMap = HzUtils.getMap(CommonHzMap.AccountUser);
