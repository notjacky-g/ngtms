...
/*    */   
/*    */ 
/* 28 */   public void init() { this.defaultHcceGroupInfo = new HcceGroupInfo("Unknown", false, ClusterMode.Standby, "Default Group"); }
/*    */   
/*    */   @Autowired
/*    */   private HcceEnv hcceEnv;
/*    */   @Autowired
/*    */   private HcceGroupInfoRepository hcceGroupInfoRepository;
/* 34 */   public ClusterMode activeOrStandby() { HcceGroupInfo info = (HcceGroupInfo)this.hcceGroupInfoRepository.findById(this.hcceEnv.getCurrentGroupName()).orElse(null);
...
/*    */   {
/* 50 */     HcceGroupInfo info = (HcceGroupInfo)this.hcceGroupInfoRepository.findById(this.hcceEnv.getCurrentGroupName()).orElse(null);
...
/*    */   {
/* 64 */     HcceGroupInfo info = (HcceGroupInfo)this.hcceGroupInfoRepository.findById(this.hcceEnv.getCurrentGroupName()).orElse(null);
/* 65 */     if (info == null)
/*    */     {
/* 67 */       throw new DisasterRecoveryException("HcceGroupInfo of " + this.hcceEnv.getCurrentGroupName() + " was not found in DRDB");
/*    */     }
...
/*    */   {
/* 76 */     HcceGroupInfo info = (HcceGroupInfo)this.hcceGroupInfoRepository.findById(this.hcceEnv.getCurrentGroupName()).orElse(null);
/* 77 */     if (info == null)
/*    */     {
/* 79 */       throw new DisasterRecoveryException("HcceGroupInfo of " + this.hcceEnv.getCurrentGroupName() + " was not found in DRDB");
/*    */     }
