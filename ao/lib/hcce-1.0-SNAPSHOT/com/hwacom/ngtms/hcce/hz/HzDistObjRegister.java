...
/* 115 */   private ApplicationContext applicationContext; private Object syncObj = new Object();
/* 116 */   private AtomicBoolean adjustHzConfigFinished = new AtomicBoolean();
...
/*     */         {
/* 147 */           throw new IllegalArgumentException("Duplicated Hazelcast distributed object name: " + obj.toHzName()); }
...
/* 186 */       if (this.adjustHzConfigFinished.get()) { return;
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/* 194 */         HzMapEnum hzMapEnum = (HzMapEnum)this.hzMapPool.get(key);
/*     */         try {
/* 196 */           setupHzMap(hzMapEnum);
/*     */         }
/*     */         catch (Exception ex) {
/* 199 */           Package hzMapPkg = HzMap.class.getPackage();
/* 200 */           if ((hzMapPkg.equals(hzMapEnum.getClass().getPackage())) && 
/* 201 */             (this.environment.getProperty("ngtms.product.mode") != null) && 
/* 202 */             ("false".equalsIgnoreCase(this.environment.getProperty("ngtms.product.mode")))) {
...
/* 225 */         HzQueueEnum hzQueueEnum = (HzQueueEnum)this.hzQueuePool.get(key);
/*     */         try {
/* 227 */           setupHzQueue(hzQueueEnum);
/*     */         }
/*     */         catch (Exception ex) {
/* 230 */           Package hzQueuePkg = HzQueue.class.getPackage();
/* 231 */           if ((hzQueuePkg.equals(hzQueueEnum.getClass().getPackage())) && 
/* 232 */             (this.environment.getProperty("ngtms.product.mode") != null) && 
/* 233 */             ("false".equalsIgnoreCase(this.environment.getProperty("ngtms.product.mode")))) {
...
/*     */     try {
/* 272 */       this.hazelcastConfig.getSerializationConfig().addPortableFactory(1, new HzPortableFactory());
/*     */     } catch (Exception ex) {
...
/* 361 */     return (HzDistObjEnum)this.hzDistObjPool.get(name);
/*     */   }
/*     */ }
