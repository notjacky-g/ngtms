...
/*     */   
/*  56 */   public static enum NmState { Idle, 
/*  57 */     Starting, 
/*  58 */     Running, 
/*  59 */     Stop;
/*     */     
/*     */     private NmState() {} }
/*     */   
/*  63 */   private static enum NmEvent { Start, 
/*  64 */     Stop, 
/*  65 */     RegisterSuccess, 
/*  66 */     RegisterFail, 
/*  67 */     Restart;
...
/*     */   private ClientConfig hazelcastClientConfig; @Autowired
/*     */   private ClusterManager hcClusterManager; @Autowired
/*     */   private FmeController fmeController; @Autowired
/*     */   private HcceEnv hcceEnv; @Autowired
/*     */   private BaseOpLogger opLogger; @Autowired
/*  82 */   private SysPerfLogService sysPerfLogService; private Object fsmSyncObj = new Object();
/*     */   private long startTime;
/*     */   
/*     */   private NodeManager() {
/*  86 */     this.startTime = System.currentTimeMillis();
/*  87 */     this.nmState.set(NmState.Idle);
/*     */   }
/*     */   
/*     */   @PostConstruct
...
/*     */   }
/*     */   
/* 102 */   private SysPerfLogListener sysPerfLogListener = new SysPerfLogListener()
/*     */   {
/*     */     public void onSysPerfLog(SysPerfLog sysPerfLog)
/*     */     {
/*     */       try {
/* 107 */         if (HzUtils.getHzInstance() != null) {
/* 108 */           IMap<String, SysPerfLog> sysPerfLogMap = HzUtils.getMap(HzMap.SysPerfLog);
...
/* 187 */       if (this.forceStop) stopStateEntry(); else
/* 188 */         runningStateEntry();
/* 189 */       break;
/*     */     case RegisterFail: 
/* 191 */       stopStateEntry();
/* 192 */       break;
...
/*     */   {
/* 265 */     return (NmState)this.nmState.get();
/*     */   }
/*     */   
...
/* 376 */       topologyInfo = (TopologyInfo)topologyMap.get(this.hcceEnv.getCurrentGroupName());
...
/*     */       }
/*     */     } catch (Exception e) { TopologyInfo topologyInfo;
...
/* 434 */           result = true;
/*     */         }
/*     */       } catch (ClusterManagerNotReadyException e) {
/* 437 */         logger.info("Failed to register current node, ClusterManager is not ready, try again later! ({})", 
/*     */         
/* 439 */           Integer.valueOf(i));
/*     */       }
/*     */       catch (RegisterNodeException e) {
/* 442 */         logger.error("Failed to register current node", e);
/*     */       }
/*     */       catch (Exception e) {
...
/*     */     {
/* 458 */       throw new NodeManagerNotReadyException("The state of NodeManager is " + this.nmState.get() + ", not in runngin state");
/*     */     }
/*     */   }
/*     */   
...
/*     */ 
/*     */ 
/*     */   public void removeFme(String fmeName)
