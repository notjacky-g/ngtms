...
/*     */   private String distributedObjectListenerId;
/*     */   
/*  33 */   public FmeController() { this.threadGroup = Thread.currentThread().getThreadGroup(); }
/*     */   
/*     */   public void start()
/*     */   {
/*  37 */     logger.info("FmeController started");
/*     */     
/*  39 */     this.distributedObjectListenerId = HzUtils.getHzInstance().addDistributedObjectListener(new MyDistributedObjectListener());
/*     */   }
/*     */   
/*     */   public void stop() {
...
/*     */ 
/*     */ 
/*     */   public synchronized void addFme(String fmeName, String className, String description)
/*     */     throws FmeOperationException
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public synchronized void startFme(String fmeName)
/*     */     throws FmeOperationException
/*     */   {
/* 111 */     FmeMainBase fmeMainBase = (FmeMainBase)this.fmeExecutorsMap.get(fmeName);
...
/*     */   {
/* 130 */     FmeMainBase fmeMainBase = (FmeMainBase)this.fmeExecutorsMap.remove(fmeName);
...
/*     */   }
/*     */   
/*     */   class MyDistributedObjectListener implements DistributedObjectListener {
/*     */     MyDistributedObjectListener() {}
/*     */     
/* 140 */     public void distributedObjectCreated(DistributedObjectEvent event) { if (event.getDistributedObject().getName().equals(HzMap.DynamicConfig.toHzName())) {
...
/* 162 */     return (FmeMainBase)this.fmeExecutorsMap.get(fmeName);
/*     */   }
/*     */ }
