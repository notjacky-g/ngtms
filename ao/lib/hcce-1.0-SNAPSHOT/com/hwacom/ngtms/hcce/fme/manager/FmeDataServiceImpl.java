...
/*     */       }
/*  58 */       Integer count = (Integer)classCountingMap.get(fmeDefinition.getClassName());
/*  59 */       if (count == null) {
/*  60 */         count = Integer.valueOf(0);
/*     */       }
/*  62 */       Integer localInteger1 = count;Integer localInteger2 = count = Integer.valueOf(count.intValue() + 1);
...
/*     */         {
/*     */ 
/*  86 */           throw new InvalidFmeDefinitionException(className + " must be a subclass of " + FmeMainBase.class.getSimpleName());
/*     */ 
/*     */         }
/*     */         
/*     */ 
...
/*     */     
/* 107 */     for (Iterator localIterator1 = fmeDefinitions.iterator(); localIterator1.hasNext();) { fmeDefinition = (FmeDefinition)localIterator1.next();
...
/* 188 */       Integer count = (Integer)classCountingMap.get(fmeDefinition.getClassName());
/* 189 */       if (count == null) {
/* 190 */         count = Integer.valueOf(0);
/*     */       }
/* 192 */       Integer localInteger1 = count;Integer localInteger2 = count = Integer.valueOf(count.intValue() + 1);
/* 193 */       classCountingMap.put(fmeDefinition.getClassName(), count);
/*     */     }
/*     */     
/* 196 */     for (String className : classCountingMap.keySet()) {
/*     */       Object fme;
/* 198 */       try { Constructor<?> c = Class.forName(className).getConstructor(new Class[] { String.class, String.class });
/* 199 */         fme = c.newInstance(new Object[] { className, null });
/* 200 */         if ((fme instanceof FmeMainBase)) {
/* 201 */           mainBase = (FmeMainBase)fme;
/* 202 */           if ((!((FmeMainBase)mainBase).isAllowConcurrentExecution()) && (((Integer)classCountingMap.get(className)).intValue() > 1)) {
...
/* 217 */           for (mainBase = fmeDefinitions.iterator(); ((Iterator)mainBase).hasNext();) { FmeDefinition fmeDefinition = (FmeDefinition)((Iterator)mainBase).next();
...
/*     */ 
/* 236 */           .toString());
/* 237 */         fme = fmeDefinitions.iterator(); } while (((Iterator)fme).hasNext()) { FmeDefinition fmeDefinition = (FmeDefinition)((Iterator)fme).next();
