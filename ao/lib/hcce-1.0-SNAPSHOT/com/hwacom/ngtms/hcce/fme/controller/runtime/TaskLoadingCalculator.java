...
/* 33 */     long sum = 0L;
/* 34 */     int count = 0;
/* 35 */     for (int i = this.exeTimeList.size() - 1; i >= 0; i--) {
/* 36 */       sum += ((Long)this.exeTimeList.get(i)).longValue();
/* 37 */       count++;
/* 38 */       if (count >= 10) break;
/*    */     }
/* 40 */     if (count != 0)
/* 41 */       this.taskLoadingCounter.setLastTenTimesAvg((sum / count + 0.5D)); else {
/* 42 */       this.taskLoadingCounter.setLastTenTimesAvg(0L);
/*    */     }
/* 44 */     for (int i = this.exeTimeList.size() - 11; i >= 0; i--) {
/* 45 */       sum += ((Long)this.exeTimeList.get(i)).longValue();
/* 46 */       count++;
/*    */     }
/* 48 */     if (count != 0)
/* 49 */       this.taskLoadingCounter.setLastHundredTimesAvg((sum / count + 0.5D)); else
/* 50 */       this.taskLoadingCounter.setLastHundredTimesAvg(0L);
