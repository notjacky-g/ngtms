...
/*     */   }
/*     */   
/*  79 */   static { System.setProperty("hcce.config.file", "conf/test/fmTest.properties"); }
/*     */   
/*     */ 
...
/*     */   @Autowired
/*     */   protected HcceEnv hcceEnv;
/*     */   @Resource
/*     */   protected Environment environment;
/*     */   private static FmeInfo[] fmeInfos;
/*     */   
/*     */   @AfterClass
/*  97 */   public static void afterClass() { staticFmeController.stop();
/*  98 */     HzUtils.getHzInstance().shutdown();
/*     */   }
/*     */   
/*     */   @Before
...
/*     */ 
/*     */ 
/*     */   protected void restartFme(String fmeName)
/*     */     throws Exception
/*     */   {
...
/*     */   {
/* 184 */     return this.fmeController.getFme(fmeName);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/*     */   protected void loadData(DbName dbName, String... dataFileNames)
/*     */     throws Exception
/*     */   {
/*     */     String password;
/*     */     
...
/* 223 */     switch (dbName) {
/*     */     case DRBD: 
/* 225 */       String driverName = this.environment.getProperty("drds.driverClassName");
/* 226 */       String url = this.environment.getProperty("drds.url");
/* 227 */       String userName = this.environment.getProperty("drds.username");
/* 228 */       password = this.environment.getProperty("drds.password");
/* 229 */       break;
/*     */     case HDDB: 
/* 231 */       String driverName = this.environment.getProperty("hdds.driverClassName");
/* 232 */       String url = this.environment.getProperty("hdds.url");
/* 233 */       String userName = this.environment.getProperty("hdds.username");
/* 234 */       password = this.environment.getProperty("hdds.password");
/* 235 */       break;
/*     */     case OLDB: 
/* 237 */       String driverName = this.environment.getProperty("olds.driverClassName");
/* 238 */       String url = this.environment.getProperty("olds.url");
/* 239 */       String userName = this.environment.getProperty("olds.username");
...
/*     */     String password;
/*     */     String userName;
/* 246 */     String url; String driverName; DbType dbType = determineDbType(driverName);
...
/*     */   
/*     */   protected void importDataBeforeHcClusterStart()
/*     */     throws Exception
/*     */   {}
/*     */   
/*     */   protected void importDataAfterHcClusterStarted()
/*     */     throws Exception
/*     */   {}
/*     */   
/*     */   protected void importDataAfterFmInstanceStarted()
/*     */     throws Exception
/*     */   {}
/*     */ }
