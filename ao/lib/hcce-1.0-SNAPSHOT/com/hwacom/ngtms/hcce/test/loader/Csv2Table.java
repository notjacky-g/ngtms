...
/*     */ 
/*     */ 
/*     */   public void loadData(String tableName, String dataFile, boolean containColumnName)
...
/*     */     {
/*  78 */       BufferedReader in = new BufferedReader(new InputStreamReader(cr.getInputStream(), "UTF8"));Throwable localThrowable9 = null;
/*  79 */       try { colLine = in.readLine();
/*  80 */         String UTF8_BOM = "﻿";
...
/*     */       {
/*  77 */         localThrowable9 = localThrowable1;throw localThrowable1;
/*     */ 
/*     */ 
/*     */       }
/*     */       finally
/*     */       {
/*     */ 
/*  84 */         if (in != null) if (localThrowable9 != null) try { in.close(); } catch (Throwable localThrowable2) { localThrowable9.addSuppressed(localThrowable2); } else in.close();
/*     */       }
/*     */     }
/*  87 */     switch (this.dbType) {
/*     */     case MySQL: 
/*  89 */       String fileName = file.getCanonicalPath().replace('\\', '/');
/*  90 */       Statement stmt = this.connection.createStatement();localThrowable1 = null;
/*     */       try { String sql;
/*     */         String sql;
...
/*     */       {
/*  90 */         localThrowable1 = localThrowable11;throw localThrowable11;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 114 */         if (stmt != null) if (localThrowable1 != null) try { stmt.close(); } catch (Throwable localThrowable5) { localThrowable1.addSuppressed(localThrowable5); } else stmt.close(); }
/* 115 */       break;
/*     */     case H2: 
/* 117 */       Statement stmt = this.connection.createStatement();localThrowable1 = null;
/*     */       try { String sql;
/* 119 */         String sql; if (containColumnName)
/*     */         {
/*     */ 
/*     */ 
/*     */ 
...
/*     */       {
/* 117 */         localThrowable1 = localThrowable13;throw localThrowable13;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 150 */         if (stmt != null) if (localThrowable1 != null) try { stmt.close(); } catch (Throwable localThrowable8) { localThrowable1.addSuppressed(localThrowable8); } else stmt.close(); }
/* 151 */       break;
/*     */     }
/*     */     
/*     */   }
...
/*     */ 
/*     */ 
/*     */   public void loadData(boolean containColumnName, String... dataFileNames)
/*     */     throws SQLException, IOException
/*     */   {
