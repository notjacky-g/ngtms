...
/*    */ 
/*    */ 
/*    */ @GlobalParams(paramsName="timeNoWeek")
/*    */ public class TimeNoWeekPm
...
/* 39 */     out.writeByte(this.min);
/* 40 */     out.writeByte(this.sec);
/*    */   }
/*    */   
/*    */   public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException
/*    */   {
/* 45 */     this.year = (in.readByte() & 0xFF);
/* 46 */     this.month = (in.readByte() & 0xFF);
/* 47 */     this.day = (in.readByte() & 0xFF);
/* 48 */     this.hour = (in.readByte() & 0xFF);
/* 49 */     this.min = (in.readByte() & 0xFF);
/* 50 */     this.sec = (in.readByte() & 0xFF);
/*    */   }
/*    */   
...
/* 60 */     sb.append("min: ").append(this.min).append(", ");
/* 61 */     sb.append("sec: ").append(this.sec).append(']');
/* 62 */     return sb.toString();
/*    */   }
/*    */ }


/* Location:              D:\TC\NJ\10.121.41.38\ngtms\ao\lib.src\nccCodec-1.0-SNAPSHOT.jar!\com\hwacom\ngtms\ncc\tc\ct3\cmdparam\TimeNoWeekPm.class
