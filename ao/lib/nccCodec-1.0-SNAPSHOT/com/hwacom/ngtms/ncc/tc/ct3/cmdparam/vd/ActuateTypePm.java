...
/*    */   public int bus;
/*    */   @CommandParam(name="left")
/*    */   public int left;
/*    */   @CommandParam(name="ramp")
/*    */   public int ramp;
/*    */   @CommandParam(name="railRoad")
/*    */   public int railRoad;
...
/* 43 */     out.writeByte(this.left);
/* 44 */     out.writeByte(this.ramp);
/* 45 */     out.writeByte(this.railRoad);
...
/* 55 */     this.left = (in.readByte() & 0xFFFF);
/* 56 */     this.ramp = (in.readByte() & 0xFFFF);
/* 57 */     this.railRoad = (in.readByte() & 0xFFFF);
...
/* 68 */     sb.append("left: ").append(this.left).append(", ");
/* 69 */     sb.append("ramp: ").append(this.ramp).append(", ");
/* 70 */     sb.append("railRoad: ").append(this.railRoad).append(", ");
...
/* Location:              D:\TC\NJ\10.121.41.38\ngtms\ao\lib.src\nccCodec-1.0-SNAPSHOT.jar!\com\hwacom\ngtms\ncc\tc\ct3\cmdparam\vd\ActuateTypePm.class
