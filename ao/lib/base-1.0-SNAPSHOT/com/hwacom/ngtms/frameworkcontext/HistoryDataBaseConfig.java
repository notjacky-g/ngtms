...
/*     */ 
/*     */ @Configuration
/*     */ @EnableJpaRepositories(entityManagerFactoryRef="hddbEntityManagerFactory", transactionManagerRef="hddbTransactionManager", basePackages={"com.hwacom.ngtms"}, includeFilters={@org.springframework.context.annotation.ComponentScan.Filter(type=org.springframework.context.annotation.FilterType.ANNOTATION, value={HistoryRepository.class})})
...
/*  68 */   public DataSource hddbDataSource() { HikariConfig conf = new HikariConfig();
...
/*  86 */     conf.setConnectionTimeout(
/*  87 */       ((Long)this.environment.getProperty("hdds.connectionTimeout", Long.class, Long.valueOf(10000L))).longValue());
...
/*     */   public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("hddbDataSource") DataSource hddbDataSource)
...
/* 161 */     entityManagerFactoryBean.setDataSource(routingDataSource);
/*     */     
...
/* 175 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
/* 178 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
...
/*     */ 
/*     */ 
/* 187 */     if ((this.environment.getProperty("ngtms.product.mode") != null) && 
/* 188 */       ("false".equalsIgnoreCase(this.environment.getProperty("ngtms.product.mode"))) && 
