...
/*     */       try
/*     */       {
/*  70 */         initCtx = (Context)ctx.lookup("java:/comp/env");
...
/*  93 */     conf.setConnectionTimeout(
/*  94 */       ((Long)this.environment.getProperty("olds.connectionTimeout", Long.class, Long.valueOf(10000L))).longValue());
...
/*     */     
/* 120 */     if (ds != null) {
/* 121 */       return new HikariDataSource(conf);
/*     */     }
/* 123 */     return null;
/*     */   }
/*     */   
...
/* 148 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
/* 151 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
...
/*     */ 
/*     */ 
/* 160 */     if ((this.environment.getProperty("ngtms.product.mode") != null) && 
/* 161 */       ("false".equalsIgnoreCase(this.environment.getProperty("ngtms.product.mode"))) && 
