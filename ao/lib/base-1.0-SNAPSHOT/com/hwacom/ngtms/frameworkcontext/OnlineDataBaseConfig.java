...
/*     */ 
/*     */ @Configuration
/*     */ @EnableJpaRepositories(entityManagerFactoryRef="oldbEntityManagerFactory", transactionManagerRef="oldbTransactionManager", basePackages={"com.hwacom.ngtms"}, includeFilters={@org.springframework.context.annotation.ComponentScan.Filter(type=org.springframework.context.annotation.FilterType.ASSIGNABLE_TYPE, value={org.springframework.data.repository.CrudRepository.class})}, excludeFilters={@org.springframework.context.annotation.ComponentScan.Filter(type=org.springframework.context.annotation.FilterType.ANNOTATION, value={HistoryRepository.class})})
...
/*  88 */     conf.setConnectionTimeout(
/*  89 */       ((Long)this.environment.getProperty("olds.connectionTimeout", Long.class, Long.valueOf(10000L))).longValue());
...
/*     */   public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("oldbDataSource") DataSource dataSource)
...
/* 172 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
/* 175 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
...
/*     */ 
/*     */ 
/* 184 */     if ((this.environment.getProperty("ngtms.product.mode") != null) && 
/* 185 */       ("false".equalsIgnoreCase(this.environment.getProperty("ngtms.product.mode"))) && 
