...
/*  95 */     if (this.netStat != null) writer.writePortable("netStat", this.netStat); else
/*  96 */       writer.writeNullPortable("netStat", 1, 1004);
/*  97 */     writer.writePortableArray("diskInfoList", (Portable[])this.diskInfoList.toArray(new DiskInfo[0]));
/*  98 */     writer.writePortableArray("netInfInfoList", (Portable[])this.netInfInfoList.toArray(new NetInfInfo[0]));
...
/*     */   {
/* 453 */     return "NodePerformance [timestamp=" + this.timestamp + ", user=" + this.user + ", sys=" + this.sys + ", nice=" + this.nice + ", idle=" + this.idle + ", wait=" + this.wait + ", irq=" + this.irq + ", combined=" + this.combined + ", loadAverage=" + Arrays.toString(this.loadAverage) + ", uptime=" + this.uptime + ", memUsed=" + this.memUsed + ", memFree=" + this.memFree + ", memTotal=" + this.memTotal + ", memUsedPercent=" + this.memUsedPercent + ", totalThreads=" + this.totalThreads + ", totalProcesses=" + this.totalProcesses + ", procId=" + this.procId + ", procMemTotoal=" + this.procMemTotoal + ", procMemResident=" + this.procMemResident + ", procCpuPercent=" + this.procCpuPercent + ", procCpuTotal=" + this.procCpuTotal + ", procJvmMaxMem=" + this.procJvmMaxMem + ", procJvmTotalMem=" + this.procJvmTotalMem + ", procJvmFreeMem=" + this.procJvmFreeMem + ", procJvmThreads=" + this.procJvmThreads + ", SystemLoadAverage=" + this.SystemLoadAverage + ", netStat=" + this.netStat + ", diskInfoList=" + this.diskInfoList + ", netInfInfoList=" + this.netInfInfoList + ", cpuInfoList=" + this.cpuInfoList + ", groupName=" + this.groupName + ", nodeName=" + this.nodeName + ", sumOfRxSpeedPerSec=" + this.sumOfRxSpeedPerSec + ", sumOfTxSpeedPerSec=" + this.sumOfTxSpeedPerSec + "]";
/*     */   }
/*     */ }
