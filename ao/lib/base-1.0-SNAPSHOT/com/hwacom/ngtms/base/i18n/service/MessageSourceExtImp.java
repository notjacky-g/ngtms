...
/*  45 */     String baseDirectory; if (this.basenamesRegex.startsWith("classpath*:")) {
/*  46 */       String baseDirectory = this.basenamesRegex.substring(11).trim();
/*  47 */       inClassPath = true;
/*  48 */     } else if (this.basenamesRegex.startsWith("classpath:")) {
/*  49 */       String baseDirectory = this.basenamesRegex.substring(10).trim();
/*  50 */       inClassPath = true;
...
/*  64 */     baseNameSet.toArray(baseNames);
/*  65 */     if (this.logger.isDebugEnabled()) this.logger.debug("base names: " + Arrays.toString(baseNames));
/*  66 */     setBasenames(baseNames);
/*     */   }
/*     */   
/*     */   public String getMessage(String code)
/*     */   {
/*  71 */     return super.getMessage(code, null, null);
/*     */   }
/*     */   
/*     */   public String getMessage(String code, Locale locale)
/*     */   {
/*  76 */     return super.getMessage(code, null, locale);
/*     */   }
/*     */   
/*     */   public String getMessage(String code, Object... args)
/*     */   {
/*  81 */     return super.getMessage(code, args, null);
/*     */   }
/*     */   
/*     */   public String getMessage(String code, Locale locale, Object... args)
/*     */   {
/*  86 */     return super.getMessage(code, args, locale);
/*     */   }
/*     */   
...
/* 102 */         names.add(key.substring(prefix.length()));
/*     */     }
/* 104 */     return names;
/*     */   }
/*     */   
...
/* 120 */         values.add(getMessage(key, null, locale));
/*     */     }
/* 122 */     return values;
/*     */   }
/*     */   
/*     */   public <E extends Enum<E>,  extends MessageType> String getEnumAbbrMessage(E messageType)
/*     */   {
/* 127 */     return getEnumMessage(messageType, ".abbr.");
/*     */   }
/*     */   
/*     */   public <E extends Enum<E>,  extends MessageType> String getEnumFullMessage(E messageType)
/*     */   {
/* 132 */     return getEnumMessage(messageType, ".full.");
/*     */   }
/*     */   
/*     */   public <E extends Enum<E>,  extends MessageType> String getEnumMessage(E messageType, String middle)
/*     */   {
/* 137 */     return getMessage(((MessageType)messageType).getMessageKeyPrefix() + middle + messageType.toString());
/*     */   }
/*     */   
/*     */ 
/*     */   public <E extends Enum<E>,  extends MessageType> Map<E, String> getEnumAbbrMessages(Class<E> messageType)
/*     */   {
/* 143 */     return getEnumMessages(messageType, ".abbr.");
/*     */   }
/*     */   
/*     */ 
/*     */   public <E extends Enum<E>,  extends MessageType> Map<E, String> getEnumFullMessages(Class<E> messageType)
/*     */   {
/* 149 */     return getEnumMessages(messageType, ".full.");
/*     */   }
/*     */   
/*     */ 
/*     */   public <E extends Enum<E>,  extends MessageType> Map<E, String> getEnumMessages(Class<E> messageType, String middle)
/*     */   {
/* 155 */     E[] enumMembers = (Enum[])messageType.getEnumConstants();
/* 156 */     HashMap<E, String> messageMap = new HashMap();
/* 157 */     for (E m : enumMembers) {
/* 158 */       messageMap.put(m, getMessage(((MessageType)m).getMessageKeyPrefix() + middle + m.toString()));
/*     */     }
