...
/*     */ 
/*     */ @Configuration
/*     */ @EnableJpaRepositories(basePackages={"com.hwacom.ngtms"}, entityManagerFactoryRef="oldbEntityManagerFactory", transactionManagerRef="oldbTransactionManager", basePackageClasses={}, includeFilters={@org.springframework.context.annotation.ComponentScan.Filter(type=org.springframework.context.annotation.FilterType.REGEX, pattern={"com.hwacom.ngtms.*.repository.*"})})
/*     */ @EnableTransactionManagement
/*     */ @ComponentScan(basePackages={"com.hwacom.ngtms"}, basePackageClasses={}, useDefaultFilters=false, includeFilters={@org.springframework.context.annotation.ComponentScan.Filter({javax.persistence.Entity.class}), @org.springframework.context.annotation.ComponentScan.Filter({org.springframework.stereotype.Repository.class})})
...
/*  80 */       ((Long)this.environment.getProperty("olds.connectionTimeout", Long.class, Long.valueOf(10000L))).longValue());
...
/* 107 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
/* 110 */     jpaProterties.put(com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[0], com.hwacom.ngtms.base.hibernate.ConfigProperties.HIBERNATE_PHYSICAL_NAMING_STRATEGY[1]);
/*     */     
/*     */ 
