...
/*  80 */     RSAPublicKeySpec ks = (RSAPublicKeySpec)kf.getKeySpec(this.keyPair.getPublic(), RSAPublicKeySpec.class);
...
/*  92 */     RSAPrivateCrtKeySpec ks = (RSAPrivateCrtKeySpec)kf.getKeySpec(this.keyPair.getPrivate(), RSAPrivateCrtKeySpec.class);
...
/* 119 */       this.provider = new BouncyCastleProvider();
...
/*     */   
/*     */ 
/*     */   public byte[] signature(String plainText, HashingAlgorithms algrithm)
...
/* 141 */     String algorithmString; if (algrithm == HashingAlgorithms.SHA1) {
...
/*     */   }
/*     */   
/*     */   public byte[] messageDigest(String plainText, HashingAlgorithms algrithm)
...
/*     */     throws IllegalBlockSizeException, BadPaddingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, UnsupportedEncodingException
/*     */   {
