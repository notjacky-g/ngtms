...
/*     */     
/* 100 */     int seed = (randomBytes[0] & 0x7F) << 24 | randomBytes[1] << 16 | randomBytes[2] << 8 | randomBytes[3];
/*     */     
/*     */ 
...
/*     */     char[] randomString;
/* 107 */     char[] randomString; if (minLength < maxLength) {
...
/* 122 */               selectableChars = selectableChars + LCaseChars;
/* 123 */             } else if ("ucase".equals(charGroup.getKey())) {
/* 124 */               selectableChars = selectableChars + UCaseChars;
/* 125 */             } else if ("num".equals(charGroup.getKey())) {
/* 126 */               selectableChars = selectableChars + NumericChars;
/* 127 */             } else if ("special".equals(charGroup.getKey())) {
