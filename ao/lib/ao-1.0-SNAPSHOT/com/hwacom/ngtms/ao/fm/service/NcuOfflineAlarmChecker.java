...
/*    */ 
/*    */ @Service
/*    */ public class NcuOfflineAlarmChecker
...
/* 28 */     PredicateBuilder pb = (new PredicateBuilder()).getEntryObject().get("deviceType").equal("NCU");
...
/* 41 */     dto.setAlarmSubType(AlarmType.NCU_OFFLINE.toString());
/* 42 */     dto.setDeviceName(status.getDeviceName());
/* 43 */     dto.setAlarmState(alarmState);
/* 44 */     dto.setTimestamp(new Date());
/* 45 */     dto.setDegree(optDegree.orElseGet(() -> Integer.valueOf(changeToAlarmLevel(AlarmType.NCU_OFFLINE, 1.0D))));
...
/* Location:              D:\TC\NJ\機房門禁10.121.41.38\ngtms\ao\lib.src\ao-1.0-SNAPSHOT.jar!\com\hwacom\ngtms\ao\fm\service\NcuOfflineAlarmChecker.class
