...
/*    */ 
/*    */ 
/*    */   public static <T extends AlarmLogContext> void sendAlarmLogDTO(AlarmClassification classification, String alarmSubType, String deviceName, String alarmSessionId, Date timestamp, Integer degree, T contextData)
/*    */   {
...
/*    */     }
/* 58 */     if (!HzUtils.getQueue(AlarmHzQueue.Message).offer(dto)) {
