...
/*  48 */       CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObj.getClass());
...
/*     */ 
/*  56 */         if (args != null) {
/*  57 */           TcResponse tcResponse = this.nccClient.sendTcRequest((String)args[0], args[1]);
/*  58 */           TcResponse newTcResponse = cmdAroundAdvice.after(tempRequestId, deviceName, tcResponse);
/*  59 */           return newTcResponse != null ? newTcResponse : tcResponse;
/*     */         }
...
/*  74 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObj.getClass());
...
/*  92 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse);
/*     */             }
/*     */           });
/*     */         }
/*     */         
...
/* 111 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObj.getClass());
...
/* 129 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse); } }, (String)args[3]);
/*     */         }
/*     */         
/*     */ 
/*     */ 
...
/* 150 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObj.getClass());
/* 151 */       if (cmdAroundAdvice != null) {
/* 152 */         final long tempRequestId = this.atomicTemptempRequestId.incrementAndGet();
/*     */         
/* 154 */         Object[] args = cmdAroundAdvice.before(tempRequestId, CmdAroundAdvice.CmdRequestType.AsyncSingleTcSingleRequest, new Object[] { deviceName, cmdBindingObj, tcResponseCallback, reqSessionId, 
/*     */         
/*     */ 
/*     */ 
/* 158 */           Long.valueOf(timeout) });
/*     */         
/* 160 */         if (args != null) {
...
/* 170 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse); } }, (String)args[3], ((Long)args[4])
/*     */           
/*     */ 
/*     */ 
/*     */ 
...
/* 189 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObjs[0].getClass());
...
/* 207 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse);
/*     */             }
/*     */           });
/*     */         }
/*     */         
...
/* 225 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObjs[0].getClass());
...
/* 243 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse); } }, (String)args[3]);
/*     */         }
/*     */         
/*     */ 
/*     */ 
...
/* 265 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObjs[0].getClass());
/* 266 */       if (cmdAroundAdvice != null) {
/* 267 */         final long tempRequestId = this.atomicTemptempRequestId.incrementAndGet();
/*     */         
/* 269 */         Object[] args = cmdAroundAdvice.before(tempRequestId, CmdAroundAdvice.CmdRequestType.AsyncSingleTcMultipleRequest, new Object[] { deviceName, cmdBindingObjs, tcResponseCallback, reqSessionId, 
/*     */         
/*     */ 
/*     */ 
/* 273 */           Long.valueOf(timeout) });
/*     */         
/* 275 */         if (args != null) {
...
/* 285 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse); } }, (String)args[3], ((Long)args[4])
/*     */           
/*     */ 
/*     */ 
/*     */ 
...
/* 304 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObj.getClass());
...
/* 322 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse);
/*     */             }
/*     */           });
/*     */         }
/*     */         
...
/* 341 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObj.getClass());
...
/* 359 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse); } }, (String)args[3]);
/*     */         }
/*     */         
/*     */ 
/*     */ 
...
/* 381 */       final CmdAroundAdvice cmdAroundAdvice = (CmdAroundAdvice)this.adviceMap.get(cmdBindingObj.getClass());
/* 382 */       if (cmdAroundAdvice != null) {
/* 383 */         final long tempRequestId = this.atomicTemptempRequestId.incrementAndGet();
/*     */         
/* 385 */         Object[] args = cmdAroundAdvice.before(tempRequestId, CmdAroundAdvice.CmdRequestType.AsyncMultipleTcSingleRequest, new Object[] { deviceNames, cmdBindingObj, tcResponseCallback, reqSessionId, 
/*     */         
/*     */ 
/*     */ 
/* 389 */           Long.valueOf(timeout) });
/*     */         
/* 391 */         if (args != null) {
...
/* 401 */               this.val$tcResponseCallback.onResponse(reqSessionId, deviceName, newTcResponse != null ? newTcResponse : tcResponse); } }, (String)args[3], ((Long)args[4])
/*     */           
/*     */ 
/*     */ 
/*     */ 
